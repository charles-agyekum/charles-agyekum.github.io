...
### [Superstore — Order Fulfilment and Profitability (Power BI)](projects/superstore-fulfilment.md)
...
### [Vrinda Store — 2022 Sales Dashboard (Excel)](projects/vrinda-store.md)
...
Women drove 63% of revenue, concentrated in two categories and two states, with
sales declining across the year. I flagged that concentration as the risk worth
watching.

### [HR Employee Attrition — Dynamic Dashboard (Excel)](projects/hr-attrition.md)
...
### [Adidas US — Interactive Sales Dashboard (Excel)](projects/adidas-us-sales.md)
...
### [SQL Practice — Joins, Subqueries and CASE](projects/sql-practice.md)
